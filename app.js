...
const contextHelpTopics = [
  ...
  ["[data-mode='group']", "Group Chat Tab", "Use this screen during a group therapy activity when several people are taking turns sending messages.\n\nSteps:\n1. Enter a participant name, such as Student or SLP.\n2. Enter a room code for the activity, such as therapy-room.\n3. Build a message on the Communicate tab.\n4. Return to Group Chat and choose Send AAC Message.\n5. Use Speak Last for the newest reply, or Speak Chat for the full transcript.\n6. Use Save Chat if you need a private text transcript.\n7. Use Clear Local Chat before a new activity.\n\nNote: This prototype only syncs across tabs or windows on the same device. Separate iPads, phones, and computers need a realtime backend added later."],
